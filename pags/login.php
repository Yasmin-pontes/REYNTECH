									...
									<div class="card-body shadow-lg">
										...
										<form action="php/login.php" method="POST">
											<div class="form-group">
												<input type="text" class="form-control my-3 py-2 input-bloco" name="email" value="<?php echo $_COOKIE['cookie_email']; ?>" placeholder="Usuário" required autofocus />
											</div>
											<div class="form-group">
												<input type="password" class="form-control my-3 py-2 input-bloco" name="senha" value="<?php echo $_COOKIE['cookie_senha']; ?>" placeholder="Senha" required autofocus />
											</div>
											<div>

												<input id="check" type="checkbox" name="cc" id="c1" value="on" <?php echo $_COOKIE['checkbox']; ?>>
